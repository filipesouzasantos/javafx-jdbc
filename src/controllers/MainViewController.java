...
public class MainViewController implements Initializable{
	...
	private synchronized void loadView(String srcView) {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource(srcView));
			...
			Alerts.showAlert("IOException", "Internal error, source view not found", e.getMessage(), AlertType.ERROR);
		}
